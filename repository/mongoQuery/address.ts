import Address from "@/database/mongo-models/address"; // Address model
...
export const selectAddressById = async (addressID: string | number) => {
...
export const deleteAddressById = async (addressID: string | number) => {
