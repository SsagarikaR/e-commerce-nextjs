...
export const getCartByUserID = async (userID: number | string) => {
  return await sequelize.query(
    `
...
export const selectFromCartItemCartID = async (cartItemID: number | string) => {
...
export const deleteFromCart = async (cartItemID: number | string) => {
  return await sequelize.query(
