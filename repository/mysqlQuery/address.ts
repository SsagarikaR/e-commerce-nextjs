...
export const selectAddressById = async (addressID: number | string) => {
...
export const updateAddress = async (
  ...
  return await sequelize.query(
    "UPDATE Addresses WHERE addressID=? SET state=?, city=?, pincode=?, locality=?, address=?",
    {
      replacements: [addressID, state, city, pincode, localiy, address],
...
export const deleteAddressById = async (addressID: number | string) => {
