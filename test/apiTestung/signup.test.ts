...
describe("/api/auth/signup Tests", () => {
  ...
  it("should return 201 and token on successful signup", async () => {
    ...
    const mockToken =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZGVudGlmaXJlIjoxOCwiaWF0IjoxNzQwOTUyODMzLCJleHAiOjE3NDE1NTc2MzN9.eL2HDI8HumYgAc7x7LbvkQl6jiWd9q1nhMN1HKHFdJE";
  ...
  it("should return 500 if there is an error in the signup process", async () => {
    ...
    vi.spyOn(UserService, "createUserService").mockRejectedValue(
